...
#### _How to use metadata from and provide metadata to online resources_    
    ...
    Objectives
    1. Demonstrate how adding good metadata to your dataset greatly increases
     it's value for the scientific community  
    2. Show examples of metadata
    3. Show different ways of providing metadata to your project (start early!)
    4. Discuss problems you may encounter with metadata and metadata schemes
