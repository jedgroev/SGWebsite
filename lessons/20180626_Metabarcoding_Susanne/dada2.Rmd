...
## Sequencing files
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.1293780.svg)](https://doi.org/10.5281/zenodo.1293780)
Download the trimmed sequencing files from Zenodo (click on the badge).  
These are ...< Susanne can you add a description of the samples here>
...
3. Place the downloaded fastq files in `~/Desktop/dada2/`. The path to the fastq files should be `~/Desktop/dada2/trimmed`  
...
filtered <- filterAndTrim(
  ...
  truncLen = c(0,0),          # truncate reads after truncLen bases. Reads shorter are discarded. Here forward reads are cut after 240nts and reverse reads are cut after 160nts
