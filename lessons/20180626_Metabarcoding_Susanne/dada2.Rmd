...
Download the taxonomic database from the [lesson Zenodo files](https://doi.org/10.5281/zenodo.1297449). Save it in your workding directory (that you specified in `my_workdir` variable). 
```{r}
# get sequences and 
db_path = file.path(my_working_dir,"pr2_version_4.10.0_dada2_7tax.fasta.gz")
taxa <- assignTaxonomy(seqtab.nochim, refFasta = db_path, multithread=TRUE)
```
