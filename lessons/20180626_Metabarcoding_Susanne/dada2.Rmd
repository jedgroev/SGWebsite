...
filtered <- filterAndTrim(
  ...
  truncLen = c(140,140),          # truncate reads after truncLen bases. Reads shorter are discarded. Here forward reads are cut after 240nts and reverse reads are cut after 160nts
