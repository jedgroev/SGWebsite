...
### FastQC 
You can check the results of the FastQC analysis in the Zenodo datafiles.   
...
## Merging of the forward/reverse reads
...
```{r}
# get the reference database path 
db_path = file.path(my_working_dir,"pr2_version_4.10.0_dada2_7tax.fa.gz")

# take a subset of all sequences (for time sake because taxonomic assignment takes some time)
seqtab.nochim.sub <- seqtab.nochim[,1:100]
taxa <- assignTaxonomy(seqtab.nochim.sub, refFasta = db_path, multithread=TRUE)
```
